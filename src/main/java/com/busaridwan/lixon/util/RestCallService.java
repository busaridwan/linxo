...
public class RestCallService {
    ...
    public  <T> Response post(Object request, String requestUrl, HttpHeaders requestHeaders, Class<T> responseClass) {
        ...
        try {
            ...
            ResponseEntity<?> resp = restTemplate.exchange(requestUrl, HttpMethod.POST,
    ...
    public  <T> Response get(String requestUrl, HttpHeaders requestHeaders, Class<T> responseClass) {
        ...
        try {
            ...
            log.info("Request Body: {}", JsonConverter.toJson(null, true));
            log.info("Url: {}", requestUrl);
            log.info("Request Entity: {}", requestEntity);

            ResponseEntity<?> resp = restTemplate.exchange(requestUrl, HttpMethod.GET,
                    requestEntity, responseClass);
            log.info("REQUEST HANDLER RESPONSE ENTITY {}", resp);
    ...
    public  <T> Object postForObject(String requestUrl, HttpEntity<?> entity, Class<T> responseClass) {
        RestTemplate restTemplate = builder.build();
